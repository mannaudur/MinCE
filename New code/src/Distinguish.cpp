    ...
    if (batch_file == "")
        {
            ...
            runSequenceFind(real_k, N, tsv_dims.first, tsv_dims.second, infile);
        ...
        else
        {
            ...
            while (std::getline(fs, clique_path))
            {
                ...
                runSequenceFind(real_k, N, tsv_dims.first, tsv_dims.second, clique_path);
